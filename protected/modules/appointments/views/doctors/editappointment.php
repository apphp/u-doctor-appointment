            ...
            <div class="one_first first_column">
				...
				echo CWidget::create('CDataForm', array(
					...
					'fields' => array(
                        ...
                        'doctor_internal_notes'   =>array('type'=>'textarea', 'title'=>A::t('appointments', 'Doctor Comments (for internal use)'), 'tooltip'=>A::t('appointments', 'Visible only for you'), 'default'=>'', 'validation'=>array('required'=>false, 'type'=>'any', 'maxLength'=>1000), 'htmlOptions'=>array('maxLength'=>'1000')),
