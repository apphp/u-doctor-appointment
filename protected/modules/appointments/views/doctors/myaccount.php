            ...
            <div class="one_first first_column">
                <div class="cmsms-form-builder">
                    ...
                    <?php
                        ...
                        $socialNetworks = '';
                        $socialNetworks .= '<p class="'.($doctor->show_social_networks ? 'full' : 'empty').'"><label class="left-label"><span>'.A::t('appointments', 'Show Social Networks').':</span></label><label class="right-label">'.($doctor->show_social_networks == 1 ? A::t('appointments', 'Yes') : A::t('appointments', 'No')).'</label></p>';
                        $socialNetworks .= '<p class="'.($doctor->social_network_facebook ? 'full' : 'empty').'"><label class="left-label"><span>'.A::t('appointments', 'Facebook Link').':</span></label><label class="right-label">'.($doctor->social_network_facebook ? '<a href="'.$doctor->social_network_facebook.'" title="Facebook" target="_blank">'.$doctor->social_network_facebook.'</a>' : '--').'</label></p>';
                        $socialNetworks .= '<p class="'.($doctor->social_network_twitter ? 'full' : 'empty').'"><label class="left-label"><span>'.A::t('appointments', 'Twitter Link').':</span></label><label class="right-label">'.($doctor->social_network_twitter ? '<a href="'.$doctor->social_network_twitter.'" title="Facebook" target="_blank">'.$doctor->social_network_twitter.'</a>' : '--').'</label></p>';
                        $socialNetworks .= '<p class="'.($doctor->social_network_youtube ? 'full' : 'empty').'"><label class="left-label"><span>'.A::t('appointments', 'YouTube Link').':</span></label><label class="right-label">'.($doctor->social_network_youtube ? '<a href="'.$doctor->social_network_youtube.'" title="Facebook" target="_blank">'.$doctor->social_network_youtube.'</a>' : '--').'</label></p>';
                        $socialNetworks .= '<p class="'.($doctor->social_network_instagram ? 'full' : 'empty').'"><label class="left-label"><span>'.A::t('appointments', 'Instagram Link').':</span></label><label class="right-label">'.($doctor->social_network_instagram ? '<a href="'.$doctor->social_network_instagram.'" title="Facebook" target="_blank">'.$doctor->social_network_instagram.'</a>' : '--').'</label></p>';
                        echo '<fieldset><legend>'.A::t('app', 'Social Networks').'</legend><div class="row">'.$socialNetworks.'</div></fieldset>';
