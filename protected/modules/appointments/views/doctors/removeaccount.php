        ...
        <div class="cmsms_cc">
            <div class="one_first first_column">
                ...
                <?php
                    ...
                    if($accountRemoved){
                        echo '<script type="text/javascript">setTimeout(function(){window.location.href = "doctors/logout";}, 5000);</script>';
                    }else{
                        echo CHtml::openForm('doctors/removeAccount', 'post', array('name'=>'remove-account-form', 'id'=>'remove-account-form', 'class'=>'doctor-form')) ;
                        ...
                        echo CHtml::link(A::t('appointments', 'Cancel'), 'doctors/myAccount', array('class'=>'button white'));
