<?php
    ...
    $this->_breadCrumbs = array(
        ...
        array('label'=>A::t('appointments', 'Visit Reasons Management')),
    );
...
<div class="bloc">
    ...
    <?php
        ...
        echo CWidget::create('CGridView', array(
            ...
            'actionPath'     => 'masterData/visitReasonsManage',
            'condition'      => '',
            ...
            'actions'=>array(
                'edit'    => array(
                    ...
                    'link'     => 'masterData/visitReasonEdit/id/{id}', 'imagePath'=>'templates/backend/images/edit.png', 'title'=>A::t('appointments', 'Edit this record')
                ),
                'delete'  => array(
                    'disabled' => !Admins::hasPrivilege('modules', 'edit') || !Admins::hasPrivilege('masterdata', 'delete'),
                    'link'     => 'masterData/visitReasonDelete/id/{id}', 'imagePath'=>'templates/backend/images/delete.png', 'title'=>A::t('appointments', 'Delete this record'), 'onDeleteAlert'=>true
                )
            ),
            'return'=>true,
        ));
