<?php
    ...
    $this->_breadCrumbs = array(
        ...
        array('label'=>A::t('appointments', 'Degrees Management')),
    );
...
<div class="bloc">
    ...
    <?php
        ...
        echo CWidget::create('CGridView', array(
            ...
            'actionPath'     => 'masterData/degreesManage',
            'condition'      => '',
            ...
            'fields'         => array(
                ...
                'title'       => array('title'=>A::t('appointments', 'Title'), 'type'=>'label', 'align'=>'', 'width'=>'120px', 'class'=>'left', 'headerClass'=>'left', 'isSortable'=>true),
            ...
            'actions'=>array(
                'edit'    => array(
                    ...
                    'link'     => 'masterData/degreeEdit/id/{id}', 'imagePath'=>'templates/backend/images/edit.png', 'title'=>A::t('appointments', 'Edit this record')
                ),
                'delete'  => array(
                    'disabled' => !Admins::hasPrivilege('modules', 'edit') || !Admins::hasPrivilege('masterdata', 'delete'),
                    'link'     => 'masterData/degreeDelete/id/{id}', 'imagePath'=>'templates/backend/images/delete.png', 'title'=>A::t('appointments', 'Delete this record'), 'onDeleteAlert'=>true
                )
            ),
            'return'=>true,
        ));
