<?php
    ...
    $this->_breadCrumbs = array(
        ...
        array('label'=>A::t('appointments', 'Add Time Slot Type')),
    );
?>
...
<div class="bloc">
    ...
    <?php
        ...
        echo CWidget::create('CDataForm', array(
            ...
            'fields' => array(
                'text_color'        => array('type'=>'color', 'title'=>A::t('appointments', 'Text Color'), 'tooltip'=>'', 'default'=>'', 'validation'=>array('required'=>false, 'type'=>'hexColor'), 'htmlOptions'=>array()),
                'background_color'  => array('type'=>'color', 'title'=>A::t('appointments', 'Background Color'), 'tooltip'=>'', 'default'=>'', 'validation'=>array('required'=>false, 'type'=>'hexColor'), 'htmlOptions'=>array()),
