...
<div class="bloc">
    ...
    <div class="content">
        ...
        echo CWidget::create('CDataForm', array(
            ...
            'operationType'=>'add',
            'action'=>'doctorSchedules/add/doctorId/'.$doctorId,
            'successUrl'=>'doctorSchedules/manage/doctorId/'.$doctorId,
            'cancelUrl'=>'doctorSchedules/manage/doctorId/'.$doctorId,
            'method'=>'post',
            'htmlOptions'=>array(
                'id'=>$formName,
                'name'=>$formName,
            ...
            'fields'=>array(
                ...
                'is_active' => array('type'=>'checkbox', 'title'=>A::t('appointments', 'Active'), 'default'=>1, 'validation'=>array('type'=>'set', 'source'=>array(0,1)), 'htmlOptions'=>array(), 'viewType'=>'custom'),
