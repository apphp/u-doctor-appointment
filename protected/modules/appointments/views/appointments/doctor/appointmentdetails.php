                ...
                <div class="link tab">
                    ...
                    <div class="tab_content">
                        ...
                        <div id="appointment_verify" class="tabs_tab" style="display: none;">
                            ...
                            <a class="button_small" href="javascript:void(0);" onclick="appointmentComplete(this);" data-type-account="doctor" data-date-time="<?= $appointmnetnDate; ?>" data-doctor-id="<?= $profileDoctor->id; ?>"><?= A::t('appointments', 'Make an Appointment'); ?></a>
