<?php
    ...
    $this->_breadCrumbs = array(
        array('label'=>A::t('testimonials', 'Modules'), 'url'=>'modules/'),
        array('label'=>A::t('testimonials', 'Testimonials'), 'url'=>'modules/settings/code/testimonials'),
...
<div class="bloc">
	...
	<?php 
        ...
        if(Admins::hasPrivilege('modules', 'edit') && Admins::hasPrivilege('testimonials', 'edit')){
            ...
            $isActive = array('title'=>A::t('testimonials', 'Active'), 'type'=>'label', 'width'=>'70px', 'class'=>'center', 'headerClass'=>'center', 'isSortable'=>true, 'definedValues'=>array('0'=>'<span class="badge-red">'.A::t('appointments', 'No').'</span>', '1'=>'<span class="badge-green">'.A::t('appointments', 'Yes').'</span>'), 'htmlOptions'=>array('class'=>'tooltip-link', 'title'=>A::te('appointments', 'Active')));
        }
