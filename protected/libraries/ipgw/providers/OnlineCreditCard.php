        ...
        $output .= CWidget::create('CFormView', array(
			...
			'fields'=>array(
				...
				'separatorCreditCard' =>array(
					...
					'cc_holder_name'=>array('type'=>'textbox',  'title'=>A::t('app', 'Card Holder\'s Name'), 'tooltip'=>'', 'mandatoryStar'=>true, 'value'=>$cRequest->getPost('cc_holder_name'), 'htmlOptions'=>array('maxLength'=>'50', 'placeholder' => A::t('appointments', 'Card Holder\'s Name Placeholder'))),
					'cc_number'=>array('type'=>'textbox', 'title'=>A::t('app', 'Credit Card Number'), 'tooltip'=>'', 'mandatoryStar'=>true, 'value'=>$cRequest->getPost('cc_number'), 'htmlOptions'=>array('maxLength'=>'50', 'placeholder' => 'XXXX XXXX XXXX XXXX')),
