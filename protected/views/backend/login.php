    ...
    <?php
		...
		if(A::app()->getCookie()->get('loginAttemptsAuth') != ''){
			...
			echo CWidget::create('CFormView', array(
				...
				'links' 	 => CConfig::get('restoreAdminPassword')
								? array('restorePassword'=>array('type'=>'link', 'linkUrl'=>'backend/restorePassword', 'linkText'=>A::t('app', 'Forgot your password?'), 'htmlOptions'=>array()))
								: array(),
