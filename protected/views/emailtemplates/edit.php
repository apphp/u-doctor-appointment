...
<div class="bloc">
	...
	<?php if(Admins::hasPrivilege('email_templates', array('view', 'edit'))): ?>
		<a href="emailTemplates/sendTestEmail/id/<?= $template->id;?>" class="prompt-action float-right email-data ml5" data-prompt-message="<?= A::te('app', 'Are you sure you want to send this email?');?>"><b class="icon-email">&nbsp;</b> <?= A::t('app', 'Send a Test Email')?></a>		
	<?php endif; ?>	
