			...
			<?php
				if($act == 'edit'):
					echo CWidget::create('CDataForm', array(
						...
						'operationType'		=> 'edit',
						'action'			=> 'settings/search/act/edit/id/'.$searchCategory->id,
						'successUrl'		=> 'settings/search',
						'cancelUrl'			=> 'settings/search',
						'passParameters'	=> true,
						'requiredFieldsAlert' => true,
						'return'			=> true,
						'htmlOptions'		=> array(
					...
					echo CWidget::create('CGridView', array(
						...
						'fields'			=> array(
							...
							'callback_method'  	=> array('title'=>A::t('app', 'Callback Method'), 'type'=>'label', 'class'=>'left', 'headerClass'=>'left', 'width'=>'270px'),
							...
							'is_active'    		=> array('title'=>A::t('app', 'Active'), 'type'=>'link', 'align'=>'', 'width'=>'90px', 'class'=>'center', 'headerClass'=>'center', 'isSortable'=>false, 'linkUrl'=>'settings/changeSearchStatus/id/{id}', 'linkText'=>'', 'definedValues'=>array('0'=>'<span class="badge-red">'.A::t('app', 'No').'</span>', '1'=>'<span class="badge-green">'.A::t('app', 'Yes').'</span>'), 'htmlOptions'=>array('class'=>'tooltip-link', 'title'=>A::t('app', 'Click to change status'))),
						),
						'actions'			=> array(
							'edit'   		=> array(
								'disabled'		=> !Admins::hasPrivilege('site_settings', 'edit'),
								'link'			=> 'settings/search/act/edit/id/{id}', 'imagePath'=>'templates/backend/images/edit.png', 'title'=>A::t('app', 'Edit this record')
							),
						),
					));
				endif;
