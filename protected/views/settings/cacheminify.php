		...
		echo CWidget::create('CFormView', array(
			...
			'fields'=> array(
	        	...
	        	'separatorCache' => array(
                    ...
                    'cacheDeleteLink' =>
                        !CFile::isDirectoryEmpty(CConfig::get('cache.path')) ? 
                        array('type'=>'link', 'title'=>A::t('app', 'Clear Cache'), 'tooltip'=>A::t('app', 'Clear Cache Tooltip'), 'linkUrl'=>'settings/cacheMinify/task/clearCache', 'linkText'=>A::t('app', 'Clear Cache'), 'htmlOptions'=>array('class'=>'settings-link', 'onclick'=>'javascript:return clearCacheAlert()'), 'prependCode'=>'[ ', 'appendCode'=>' ]') :
	        	...
	        	'separatorMinifyCss' => array(
                    ...
                    'minifyAllowed' 		=> array('type'=>'label', 'title'=>A::t('app', 'Enabled'), 'tooltip'=>A::t('app', 'Minify Tooltip'), 'value'=>$cssMinifyEnable, 'definedValues'=>array(''=>'<span class="badge-red badge-square">'.A::t('app', 'No').'</span>', '1'=>'<span class="badge-green badge-square">'.A::t('app', 'Yes').'</span>'), 'format'=>''),
                    'minifyPath' 			=> array('type'=>'label', 'title'=>A::t('app', 'Minify Path'), 'tooltip'=>A::t('app', 'Minify Path Tooltip'), 'value'=>$cssMinifyPath, 'definedValues'=>array(), 'format'=>''),
                    'minifyFiles' 			=> array('type'=>'label', 'title'=>A::t('app', 'CSS Minify Size'), 'tooltip'=>'', 'value'=>$minifyFiles, 'definedValues'=>array(), 'format'=>''),
                    'minifyDeleteLink' =>
                        !CFile::isDirectoryEmpty(CConfig::get('compression.css.path')) ? 
                        array('type'=>'link', 'title'=>A::t('app', 'Clear CSS Minification'), 'tooltip'=>A::t('app', 'Delete Minify CSS Files Tooltip'), 'linkUrl'=>'settings/cacheMinify/task/clearCssMinify', 'linkText'=>A::t('app', 'Clear CSS Minification'), 'htmlOptions'=>array('class'=>'settings-link', 'onclick'=>'javascript:return clearMinifyAlert()'), 'prependCode'=>'[ ', 'appendCode'=>' ]') :
